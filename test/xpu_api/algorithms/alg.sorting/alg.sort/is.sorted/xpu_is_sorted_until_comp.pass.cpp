            ...
            cgh.single_task<Iter>([=]() {
                {
                    ...
                    ret_acc[0] &= (dpl::is_sorted_until(Iter(a), Iter(a + sa), dpl::greater<T>()) == Iter(a + sa));
                }
                {
                    T a[] = {1, 0, 0};
                    unsigned sa = sizeof(a) / sizeof(a[0]);
                ...
                }
                {
                    T a[] = {1, 0, 1};
                    unsigned sa = sizeof(a) / sizeof(a[0]);
                    ret_acc[0] &= (dpl::is_sorted_until(Iter(a), Iter(a + sa), dpl::greater<T>()) == Iter(a + 2));
                }
                {
                    T a[] = {0, 0, 1, 1};
                    unsigned sa = sizeof(a) / sizeof(a[0]);
                ...
                }
                {
                    T a[] = {0, 1, 0, 0};
                    unsigned sa = sizeof(a) / sizeof(a[0]);
                    ret_acc[0] &= (dpl::is_sorted_until(Iter(a), Iter(a + sa), dpl::greater<T>()) == Iter(a + 1));
                }
                {
                    T a[] = {0, 1, 0, 1};
                    unsigned sa = sizeof(a) / sizeof(a[0]);
