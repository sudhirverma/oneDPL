...
struct test_uninitialized_copy
{
               ...
               /*is_trivial<T>=*/::std::false_type)
    {
        ...
        dpl::uninitialized_copy(exec, first, last, out_first);
...
struct test_uninitialized_copy_n
{
               ...
               /*is_trivial<T>=*/::std::false_type)
    {
        ...
        dpl::uninitialized_copy_n(exec, first, n, out_first);
...
struct test_uninitialized_move
{
               ...
               /*is_trivial<T>=*/::std::false_type)
    {
        ...
        dpl::uninitialized_move(exec, first, last, out_first);
...
struct test_uninitialized_move_n
{
               ...
               /*is_trivial<T>=*/::std::false_type)
    {
        ...
        dpl::uninitialized_move_n(exec, first, n, out_first);
