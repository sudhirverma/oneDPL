...
struct test_one_policy
{
               ...
               Compare compare)
    {
        ...
        RandomAccessIterator exp = dpl::partial_sort_copy(first, last, exp_first, exp_last, compare);
        RandomAccessIterator res = dpl::partial_sort_copy(exec, first, last, d_first, d_last, compare);
    ...
    {
        prepare_data(first, last, n1, trash);
        RandomAccessIterator exp = dpl::partial_sort_copy(first, last, exp_first, exp_last);
        RandomAccessIterator res = dpl::partial_sort_copy(exec, first, last, d_first, d_last);
