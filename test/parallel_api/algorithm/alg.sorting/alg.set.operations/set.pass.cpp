...
init(InputIterator1 first1, InputIterator1 last1, InputIterator2 first2, InputIterator2 last2)
    -> dpl::pair<Sequence<typename ::std::iterator_traits<InputIterator1>::value_type>,
...
struct test_set_difference
{
               ...
               Compare comp)
    {
        ...
        auto expect = sequences.first;
        auto out = sequences.second;
        auto expect_res = dpl::set_difference(first1, last1, first2, last2, expect.begin(), comp);
        auto res = dpl::set_difference(exec, first1, last1, first2, last2, out.begin(), comp);
    ...
    operator()(Policy&& exec, InputIterator1 first1, InputIterator1 last1, InputIterator2 first2, InputIterator2 last2)
    {
        ...
        auto expect = sequences.first;
        auto out = sequences.second;
        auto expect_res = dpl::set_difference(first1, last1, first2, last2, expect.begin());
        auto res = dpl::set_difference(exec, first1, last1, first2, last2, out.begin());
...
struct test_set_symmetric_difference
{
               ...
               Compare comp)
    {
        ...
        auto expect = sequences.first;
        auto out = sequences.second;
        auto expect_res = dpl::set_symmetric_difference(first1, last1, first2, last2, expect.begin(), comp);
        auto res = dpl::set_symmetric_difference(exec, first1, last1, first2, last2, out.begin(), comp);
    ...
    operator()(Policy&& exec, InputIterator1 first1, InputIterator1 last1, InputIterator2 first2, InputIterator2 last2)
    {
        ...
        auto expect = sequences.first;
        auto out = sequences.second;
        auto expect_res = dpl::set_symmetric_difference(first1, last1, first2, last2, expect.begin());
        auto res = dpl::set_symmetric_difference(exec, first1, last1, first2, last2, out.begin());
