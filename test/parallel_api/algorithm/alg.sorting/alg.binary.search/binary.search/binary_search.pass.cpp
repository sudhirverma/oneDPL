...
main()
{
    ...
    test3buffers<sycl::usm::alloc::shared, test_binary_search<ValueType>, 0 /* start test from n = 0 */>();
    // Run tests for USM device memory
    test3buffers<sycl::usm::alloc::device, test_binary_search<ValueType>, 0 /* start test from n = 0 */>();
#endif // TEST_DPCPP_BACKEND_PRESENT

#if TEST_DPCPP_BACKEND_PRESENT
    test_algo_three_sequences<test_binary_search<ValueType>, 0 /* start test from n = 0 */>();
#else
    test_algo_three_sequences<ValueType, test_binary_search, 0 /* start test from n = 0 */>();
#endif // TEST_DPCPP_BACKEND_PRESENT
