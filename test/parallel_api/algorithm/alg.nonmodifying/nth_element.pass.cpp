...
struct test_without_compare
{
               ...
               Generator1 generator1, Generator2 generator2)
    {
        ...
        EXPECT_TRUE(dpl::find_first_of(first2, mid2, mid2, last2, [](Type& x, Type& y) { return y < x; }) == mid2,
...
struct test_with_compare
{
               ...
               Generator1 generator1, Generator2 generator2, Compare comp)
    {
        ...
        EXPECT_TRUE(dpl::find_first_of(first2, mid2, mid2, last2, [comp](Type& x, Type& y) { return comp(y, x); }) == mid2,
