...
DEFINE_TEST(test_uninitialized_default_construct)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 /* last1 */, Size n)
    {
        ...
        dpl::uninitialized_default_construct(make_new_policy<new_kernel_name<Policy, 0>>(exec), first1 + (n / 3),
                                             first1 + (n / 2));
        wait_and_throw(exec);
...
DEFINE_TEST(test_uninitialized_default_construct_n)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 /* last1 */, Size n)
    {
        ...
        dpl::uninitialized_default_construct_n(make_new_policy<new_kernel_name<Policy, 0>>(exec), first1, n);
        wait_and_throw(exec);
...
DEFINE_TEST(test_uninitialized_value_construct)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 /* last1 */, Size n)
    {
        ...
        dpl::uninitialized_value_construct(make_new_policy<new_kernel_name<Policy, 0>>(exec), first1 + (n / 3),
                                           first1 + (n / 2));
        wait_and_throw(exec);
...
DEFINE_TEST(test_uninitialized_value_construct_n)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 /* last1 */, Size n)
    {
        ...
        dpl::uninitialized_value_construct_n(make_new_policy<new_kernel_name<Policy, 0>>(exec), first1, n);
        wait_and_throw(exec);
...
DEFINE_TEST(test_destroy)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 /* last1 */, Size n)
    {
        ...
        dpl::destroy(make_new_policy<policy_name_wrapper<new_kernel_name<Policy, 0>, T1>>(exec), first1 + (n / 3),
                     first1 + (n / 2));
...
DEFINE_TEST(test_destroy_n)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 /* last1 */, Size n)
    {
        ...
        dpl::destroy_n(make_new_policy<policy_name_wrapper<new_kernel_name<Policy, 0>, T1>>(exec), first1, n);
        if(!::std::is_trivially_destructible<T1>::value)
            value = T1{-2};
        wait_and_throw(exec);
...
DEFINE_TEST(test_replace)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Size n)
    {
        ...
        dpl::replace(make_new_policy<new_kernel_name<Policy, 0>>(exec), first1, last1, value, T1(value + 1));
        wait_and_throw(exec);
